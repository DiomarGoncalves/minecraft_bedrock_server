...
const AddonManager: React.FC<CommonProps> = ({ showToast }) => {
  ...
  const handleDelete = async (type: string, id: string) => {
    ...
    try {
        const res = await fetch(`/api/addons/${type}/${id}`, { method: 'DELETE' });
        if(res.ok) {
    ...
    <div className="max-w-6xl mx-auto space-y-8 pb-10">
      ...
      <div className="bg-gray-800 border border-gray-700 rounded-xl p-8 text-center shadow-xl">
        ...
        <p className="text-gray-400 text-sm mb-6 max-w-md mx-auto mt-2">
            ...
            The system will analyze the <code>manifest.json</code> and install it to the <strong>development</strong> folders.
        </p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
            <div className="flex items-center space-x-3 mb-6 border-b border-gray-700 pb-4">
                ...
                <div>
                    <h3 className="text-lg font-bold text-white">Development Behavior Packs</h3>
                    <p className="text-xs text-gray-500">Located in <code>development_behavior_packs</code></p>
                </div>
            </div>
        ...
        <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700">
            <div className="flex items-center space-x-3 mb-6 border-b border-gray-700 pb-4">
                ...
                <div>
                    <h3 className="text-lg font-bold text-white">Development Resource Packs</h3>
                    <p className="text-xs text-gray-500">Located in <code>development_resource_packs</code></p>
                </div>
            </div>
